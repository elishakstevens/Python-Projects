...
#
# Purpose: The Tech Academy - Python Course; Creating first Python program.
#          Demonstrating how to pass variables from function to function while
#          prducting a functional game.
...
def lose(nice, mean, name):
    # Substitute the {} with our variable values
    print("\nAhhh too bad, game over! \n{}, you live in a dirty beat-up \ntent in the forest, wretched and alone!".format(name))
    # call again function and pass in our variables
    again(nice, mean, name)
...
def reset(nice, mean, name):
    nice = 0
    mean = 0
    # Name variable does not need to be reset as that same user has elected to play again
